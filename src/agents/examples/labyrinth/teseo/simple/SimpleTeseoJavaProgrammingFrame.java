package agents.examples.labyrinth.teseo.simple;

import gui.io.FileFilter;
import gui.log.*;
...
//      agent.setCommands( sb.toString() );
    ...
    public void jCompileButton_actionPerformed(ActionEvent actionEvent) {
        ...
        StringBuffer sb = new StringBuffer();
        sb.append("import agents.examples.labyrinth.teseo.simple.*;\n");
        sb.append("import agents.*;\n");
        sb.append("import agents.examples.labyrinth.teseo.*;\n");
        ...
        reflect.compiler.Compiler compiler = new reflect.compiler.Compiler();
