 ...
 */
package types.collection.tree.bplus.immutable;
...
import sort.Order;
import sort.Search;
import types.collection.Location;
import types.collection.SearchCollection;
import types.collection.tree.bplus.BPlusInnerNode;
import types.collection.tree.bplus.BPlusIterator;
import types.collection.tree.bplus.BPlusLocation;
import types.collection.tree.bplus.memory.MemoryLeafNode;
...
public class ImmutableBPlus<T> implements SearchCollection<T> {
    ...
    public Order<T> key_order() {
        return order;
    }

    public Order<ImmutableNode<T>> node_order() {
        return node_order;
    }
